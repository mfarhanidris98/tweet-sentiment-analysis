...
public class Iterator implements DataSetIterator {
     ...
     */
    public Iterator(String dataDirectory, WordVectors wordVectors, int batchSize, int truncateLength, boolean train) throws IOException {
        this.batchSize = batchSize;
        this.vectorSize = wordVectors.getWordVector(wordVectors.vocab().wordAtIndex(0)).length;


        File p = new File(FilenameUtils.concat(dataDirectory, "tweets-labeled/" + (train ? "train" : "test") + "/pos/") + "/");
        File n = new File(FilenameUtils.concat(dataDirectory, "tweets-labeled/" + (train ? "train" : "test") + "/neg/") + "/");
    ...
    private DataSet nextDataSet(int num) throws IOException {
        ...
        for( int i=0; i<num && cursor<totalExamples(); i++ ){
            if(cursor % 2 == 0){
                ...
                System.out.println("pos: " + positiveFiles[posReviewNumber].getName() + "| " + review);
                reviews.add(review);
                positive[i] = true;
            } else {
                ...
                System.out.println("neg: " + negativeFiles[negReviewNumber].getName() + "| " + review);
                reviews.add(review);
                positive[i] = false;
            }
            cursor++;
        ...
        List<String> allTokens = new ArrayList<String>(reviews.size());
        int maxLength = 0;
        for(String s : reviews){
            ...
            allTokens.addAll(tokensFiltered);
